...
describe('AuthenticateUserForm', function () {
    describe('userNameOrEmail', function () {
        it('Add error when empty userNameOrEmail', function () {
            var user = new _AuthenticateUserForm2.default({ userNameOrEmail: '', password: '' });
        ...
        describe('UserName', function () {
            it('Do not add error when valid username', function () {
                var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana', password: '' });
        ...
        describe('Email', function () {
            it('Add error when invalid email', function () {
                var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana@gmailcom', password: '' });
                (0, _ptzAssert.contains)(user.errors, _errors2.default.ERROR_USER_EMAIL_INVALID);
            });
            it('Do not add error when valid email', function () {
                var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana@gmail.com', password: '' });
    ...
    describe('Password', function () {
        it('Add error when null password', function () {
            var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana', password: null });
        ...
        it('Do not add error when valid password', function () {
            var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana', password: 'superSecret' });
        ...
        it('Add error when minlength password', function () {
            var user = new _AuthenticateUserForm2.default({ userNameOrEmail: 'angeloocana', password: 'a' });
        ...
        it('Add error when maxlength password', function () {
            var user = new _AuthenticateUserForm2.default({
